...
public class MovieDistance extends AppCompatActivity {
    String id_film ;
    String username ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distance_one);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        displayInfosDialog() ;

        id_film = getIntent().getStringExtra("id_film") ;
        username = getIntent().getStringExtra("username") ;
        new AsyncLoad().execute(id_film) ;
    }

    private class AsyncLoad extends AsyncTask<String, String, String>{
        ProgressDialog pdLoading = new ProgressDialog(MovieDistance.this) ;
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(RoadsURL.URL_TCHEBYCHEV) ;
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("id_film", strings[0]) ;
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("Successful")) {
                ...
                RecyclerViewAdapter adapter = new RecyclerViewAdapter(MovieDistance.this, names, posters, id_list, username);
                GridLayoutManager lLayout = new GridLayoutManager(MovieDistance.this, 3);
                RecyclerView rView = (RecyclerView)findViewById(R.id.recycler_view);
                rView.setHasFixedSize(true);
                rView.setLayoutManager(lLayout);
                RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(MovieDistance.this, names, posters, id_list, username);
    ...
    private void displayInfosDialog() {
        Context context = MovieDistance.this;
        String title = "Informations";
        String message = "Algorithm used : Tchebychev !" ;
