...
public class ResearchDistance2 extends AppCompatActivity {
    String username ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_similar_to);
    ...
    private class AsyncLoading extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(ResearchDistance2.this) ;
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("Successful")) {
                ...
                RecyclerSuggestionsAdapter adapter = new RecyclerSuggestionsAdapter(ResearchDistance2.this, names, posters, id_data, username, 1);
                GridLayoutManager lLayout = new GridLayoutManager(ResearchDistance2.this, 3);
                RecyclerView rView = (RecyclerView)findViewById(R.id.recycler_view);
                rView.setHasFixedSize(true);
                rView.setLayoutManager(lLayout);
                RecyclerSuggestionsAdapter rcAdapter = new RecyclerSuggestionsAdapter(ResearchDistance2.this, names, posters, id_data, username, 1);
