...
public class ResearchDistance extends AppCompatActivity {
    String username ;
    ...
    private class AsyncLoading extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(ResearchDistance.this) ;
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("Successful")) {
                ...
                RecyclerSuggestionsAdapter adapter = new RecyclerSuggestionsAdapter(ResearchDistance.this, names, posters, id_data, username, 2);
                GridLayoutManager lLayout = new GridLayoutManager(ResearchDistance.this, 3);
                RecyclerView rView = (RecyclerView)findViewById(R.id.recycler_view);
                rView.setHasFixedSize(true);
                rView.setLayoutManager(lLayout);
                RecyclerSuggestionsAdapter rcAdapter = new RecyclerSuggestionsAdapter(ResearchDistance.this, names, posters, id_data, username, 2);
