...
public class MovieDistanceUsers extends AppCompatActivity {
    String username ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncLoad().execute(username) ;
    }

    private class AsyncLoad extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(MovieDistanceUsers.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(RoadsURL.URL_USERS_DISTANCE);
                ...
                Uri.Builder builder = new Uri.Builder().appendQueryParameter("name", strings[0]);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Successful")) {
                ...
                RecyclerViewAdapter adapter = new RecyclerViewAdapter(MovieDistanceUsers.this, names, posters, id_list, username);
                GridLayoutManager lLayout = new GridLayoutManager(MovieDistanceUsers.this, 3);
                RecyclerView rView = (RecyclerView) findViewById(R.id.recycler_view);
                rView.setHasFixedSize(true);
                rView.setLayoutManager(lLayout);
                RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(MovieDistanceUsers.this, names, posters, id_list, username);
