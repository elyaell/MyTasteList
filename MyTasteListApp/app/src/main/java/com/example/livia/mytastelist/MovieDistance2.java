...
public class MovieDistance2 extends AppCompatActivity {
    String id_film ;
    String username ;
    ...
    private class AsyncLoad extends AsyncTask<String, String, String> {
        ProgressDialog pdLoading = new ProgressDialog(MovieDistance2.this);
        ...
        protected String doInBackground(String... strings) {
            try {
                url = new URL(RoadsURL.URL_COSINUS);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("Successful")) {
                ...
                RecyclerViewAdapter adapter = new RecyclerViewAdapter(MovieDistance2.this, names, posters, id_list, username);
                GridLayoutManager lLayout = new GridLayoutManager(MovieDistance2.this, 3);
                RecyclerView rView = (RecyclerView) findViewById(R.id.recycler_view);
                rView.setHasFixedSize(true);
                rView.setLayoutManager(lLayout);
                RecyclerViewAdapter rcAdapter = new RecyclerViewAdapter(MovieDistance2.this, names, posters, id_list, username);
    ...
    private void displayInfosDialog() {
        Context context = MovieDistance2.this;
        String title = "Informations";
        String message = "Algorithm used : Cosine !" ;
